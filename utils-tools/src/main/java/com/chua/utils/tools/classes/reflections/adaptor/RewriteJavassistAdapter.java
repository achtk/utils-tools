package com.chua.utils.tools.classes.reflections.adaptor;
 ...
 * @since 2020/11/18
 */
public class RewriteJavassistAdapter implements MetadataAdapter<ClassFile, FieldInfo, MethodInfo> {
