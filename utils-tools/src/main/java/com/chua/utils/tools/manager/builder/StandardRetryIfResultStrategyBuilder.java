 ...
 * @since 2020/11/9
 */
public class StandardRetryIfResultStrategyBuilder<T> implements RetryStrategyBuilder<T>, StrategyBuilder<T> {
    ...
    public T create(T entity) {
        ...
        retryStrategy.setReturnPredicate(input -> predicate.test(input));
