...
import static com.chua.utils.tools.enums.ZoneIdEnum.CTT;
...
public class DateFormatConstant {
     ...
     * H:m:s  比如：17:6:30
     */
    public static DateTimeFormatter H_M_S_FMT = DateTimeFormatter.ofPattern(H_M_S).withZone(ZONE);
     ...
     * HH时mm分ss秒  比如：17时06分30秒
     */
    public static DateTimeFormatter HH_MM_SS_CN_FMT = DateTimeFormatter.ofPattern(HH_MM_SS_CN).withZone(ZONE);

    /**
     * HH:mm  比如：17:06
     */
    public static DateTimeFormatter HH_MM_FMT = DateTimeFormatter.ofPattern(HH_MM).withZone(ZONE);

    /**
     * H:m  比如：17:6
     */
    public static DateTimeFormatter H_M_FMT = DateTimeFormatter.ofPattern(H_M).withZone(ZONE);

    /**
     * HH时mm分 比如：17时06分
     */
    public static DateTimeFormatter HH_MM_CN_FMT = DateTimeFormatter.ofPattern(HH_MM_CN).withZone(ZONE);

    /**
     * hh:mm a 比如：05:06 下午
     */
    public static DateTimeFormatter HH_MM_A_FMT = DateTimeFormatter.ofPattern(HH_MM_A).withZone(ZONE);

    /**
     * hh:mm a 比如：05:06 PM  AM PM
     */
    public static DateTimeFormatter HH_MM_A_AM_PM_FMT = DateTimeFormatter.ofPattern(HH_MM_A, Locale.ENGLISH).withZone(ZONE);
     ...
     * HH:mm:ss.SSS  比如：17:26:30.272
     */
    public static DateTimeFormatter HH_MM_SS_SSS_FMT = DateTimeFormatter.ofPattern(HH_MM_SS_SSS).withZone(ZONE);
     ...
     * HH:mm:ss.SSSSSS  比如：17:26:30.272150
     */
    public static DateTimeFormatter HH_MM_SS_SSSSSS_FMT = DateTimeFormatter.ofPattern(HH_MM_SS_SSSSSS).withZone(ZONE);
     ...
     * HH:mm:ss.SSSSSSSSS  比如：17:26:30.272150620
     */
    public static DateTimeFormatter HH_MM_SS_SSSSSSSSS_FMT = DateTimeFormatter.ofPattern(HH_MM_SS_SSSSSSSSS).withZone(ZONE);
