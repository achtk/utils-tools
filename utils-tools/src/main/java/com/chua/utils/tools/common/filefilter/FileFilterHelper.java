...
public class FileFilterHelper {
    ...
    /**
     * <p>
     * Applies an {@link FileFilter} to the provided {@link File}
     ...
     * @since 2.0
     */
    public static FileFilter prefixFileFilter(final String prefix, final IOCase caseSensitivity) {
     ...
     * @since 2.0
     */
    public static FileFilter suffixFileFilter(final String suffix, final IOCase caseSensitivity) {
     ...
     * @see #and(FileFilter...)
     * @see AndFileFilter
     * @deprecated use {@link #and(FileFilter...)}
     */
    @Deprecated
    public static FileFilter andFileFilter(final FileFilter filter1, final FileFilter filter2) {
     ...
     * @see #or(FileFilter...)
     * @see OrFileFilter
     * @deprecated use {@link #or(FileFilter...)}
     */
    @Deprecated
    public static FileFilter orFileFilter(final FileFilter filter1, final FileFilter filter2) {
    ...
    public static List<FileFilter> toList(final FileFilter... filters) {
        ...
        final List<FileFilter> list = new ArrayList<>(filters.length);
     ...
     * @see NotFileFilter
     */
    public static FileFilter notFileFilter(final FileFilter filter) {
     ...
     */
    public static FileFilter asFileFilter(final FileFilter filter) {
     ...
     * @see DelegateFileFilter
     */
    public static FileFilter asFileFilter(final FilenameFilter filter) {
        return new DelegateFileFilter(filter);
    }
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final long cutoff) {
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final long cutoff, final boolean acceptOlder) {
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final Date cutoffDate) {
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final Date cutoffDate, final boolean acceptOlder) {
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final File cutoffReference) {
     ...
     * @since 1.2
     */
    public static FileFilter ageFileFilter(final File cutoffReference, final boolean acceptOlder) {
     ...
     * @since 1.2
     */
    public static FileFilter sizeFileFilter(final long threshold) {
     ...
     * @since 1.2
     */
    public static FileFilter sizeFileFilter(final long threshold, final boolean acceptLarger) {
     ...
     * @return an appropriately configured FileFilter
     * @see SizeFileFilter
     * @since 1.3
     */
     ...
     * @since 2.0
     */
    public static FileFilter magicNumberFileFilter(final String magicNumber) {
     ...
     * @since 2.0
     */
    public static FileFilter magicNumberFileFilter(final String magicNumber, final long offset) {
     ...
     * @since 2.0
     */
    public static FileFilter magicNumberFileFilter(final byte[] magicNumber) {
        return new MagicNumberFileFilter(magicNumber);
    }
     ...
     * @since 2.0
     */
    public static FileFilter magicNumberFileFilter(final byte[] magicNumber, final long offset) {
        return new MagicNumberFileFilter(magicNumber, offset);
    }
     ...
     * @since 1.3
     */
    public static FileFilter makeDirectoryOnly(final FileFilter filter) {
        if (filter == null) {
            return DirectoryFileFilter.DIRECTORY;
        }
     ...
     * @since 1.3
     */
    public static FileFilter makeFileOnly(final FileFilter filter) {
        if (filter == null) {
            return FileFileFilter.FILE;
        }
