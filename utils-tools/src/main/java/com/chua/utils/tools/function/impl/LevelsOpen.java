...
public class LevelsOpen implements Levels {
    ...
    private void mergeList(Object leftList, Object rightList) {
        List<Object> temp = CollectionUtils.asList(leftList);
        if (temp.isEmpty()) {
            if (CollectionUtils.isList(rightList)) {
                temp.addAll(CollectionUtils.asList(rightList));
            } else {
                temp.add(rightList);
            }
            return;
        ...
        List<Object> list = CollectionUtils.asList(rightList);
    ...
    private void intoTemp(int offset, List<Object> temp, List<Object> list) {
        ...
        if (isAllMap(o2, o3)) {
            Map<String, Object> o2Temp = MapUtils.asMap(o2);
            Map<String, Object> o3Temp = MapUtils.asMap(o3);
