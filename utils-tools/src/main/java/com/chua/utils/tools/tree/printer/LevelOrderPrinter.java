 ...
 * 146   445   600   800
 */
public final class LevelOrderPrinter implements Printer {
    /**
     * 节点之间允许的最小间距（最小只能填1）
     */
    ...
    public LevelOrderPrinter(PrintTree tree) {
        this.tree = tree;
    ...
    public String printString() {
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            for (Node node : rowNodes) {
                ...
                rowSb.append(leftSpace <= 0 ? "" : String.format("%" + leftSpace + "s", ""));
    ...
    private class Node {
        ...
        public Node(Object btNode, PrintTree opetaion) {
    ...
    private class LevelInfo {
        ...
        public LevelInfo(LevelOrderPrinter.Node left, LevelOrderPrinter.Node right) {
