...
public class HttpExample {
    ...
    public static void main(String[] args) {
        ...
        HttpClientFactory httpClientFactory = extensionLoader.getExtension("rest");
        HttpClientStream httpClientStream = httpClientFactory.newGet();
        ResponseEntity responseEntity = httpClientStream.url("https://blog.csdn.net/wz6178/article/details/103721735").https().build().execute();
