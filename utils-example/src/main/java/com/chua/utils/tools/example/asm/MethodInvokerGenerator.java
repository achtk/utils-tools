 ...
 */
package com.chua.utils.tools.example.asm;
...
public class MethodInvokerGenerator {
    ...
    private static final String superType = "com/chua/utils/tools/example/asm/MethodInvoker";
    private static final String[] interfaces = { "com/chua/utils/tools/example/asm/Invoker" };
