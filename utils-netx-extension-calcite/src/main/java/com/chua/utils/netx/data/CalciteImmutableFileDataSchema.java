...
import com.chua.utils.netx.data.calcite.immutable.AbstractImmutableFileDataSchema;
 ...
 */
@NoArgsConstructor
public class CalciteImmutableFileDataSchema implements DataSchema<String>, SchemaFactory {

    private AbstractImmutableFileDataSchema fileDataSchema;
    private String data;
    private String schema = "system";
    private static final String DATA_FILE = "dataFile";

    public CalciteImmutableFileDataSchema(String data) {
        this.initial(data);
    }
    ...
    public void initial(String data) {
        ...
        AbstractImmutableFileDataSchema fileDataSchema = ExtensionFactory.getExtensionLoader(AbstractImmutableFileDataSchema.class).getExtension(extension1);
        if (null == fileDataSchema) {
