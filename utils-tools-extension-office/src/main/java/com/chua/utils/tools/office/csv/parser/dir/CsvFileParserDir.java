package com.chua.utils.tools.office.csv.parser.dir;
 ...
 * @since 2020/11/16
 */
public class CsvFileParserDir implements ParserDir {

    private final File file;
    private final Matcher<ParserFile> matcher;

    public CsvFileParserDir(File file, Matcher<ParserFile> matcher) {
    ...
    public Iterable<ParserFile> getFiles() {
        ...
        if (file.isFile()) {
            ParserFile parserFile = new CsvFileParserFile(CsvFileParserDir.this, file);
            ...
            FileHelper.doWith(file.getAbsolutePath(), path -> {
                ...
                ParserFile parserFile = new CsvFileParserFile(CsvFileParserDir.this, path.toFile());
                Matcher.doWith(matcher, parserFile);
                parserFileList.add(parserFile);
            });
        }
