...
public interface DocumentContextAware<DTO> extends AutoCloseable {
     ...
     */
    void updateDocument(DocumentMap documentMap) throws Exception;
     ...
     * @throws Exception Exception
     */
    void updateDocuments(List<DocumentMap> documentMaps) throws Exception;
     ...
     * @throws Exception Exception
     */
    long deleteDocument(String expression) throws Exception;
     ...
     * @throws Exception Exception
     */
    DocumentData<Map<String, Object>> searchKeyword(Search search) throws Exception;
